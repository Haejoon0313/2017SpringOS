...
bool page_insert(struct file * file, off_t ofs, uint8_t * upage, uint32_t read_bytes, uint32_t zero_bytes, bool writable);
...
void page_table_lock_acquire(void);
void page_table_lock_release(void);
